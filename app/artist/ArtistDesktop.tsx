...
const ArtistDesktop = () => {
  ...
  // Lazily initialise Upohar audio once on client
  const getUpohar = () => {
    ...
    <div className="w-screen bg-[#ffffff] overflow-y-scroll overflow-x-hidden flex flex-col no-scrollbar min-h-screen">
      <div className="w-full flex-grow flex flex-col items-center justify-center relative">
        ...
        <div className="w-full h-[16rem] flex justify-center items-center mt-[5rem] gap-8 flex-col lg:flex-row">
          ...
          <div className="w-[45rem] h-[16rem] flex justify-center items-start scale-75 lg:scale-100 xl:scale-100 pointer-events-none select-none">
            ...
            <div className="w-[12rem] h-[16rem] bg-[#b02227] bg-[url('https://res.cloudinary.com/dybzo3xly/image/upload/v1742914160/bgSvg_mzeadi.svg')] bg-[length:100%_100%] z-20 scale-125 rounded-lg flex flex-col justify-center items-center gap-2 transition-transform duration-300">
        ...
        <div className={`fixed top-0 left-0 w-full h-full flex justify-center items-center z-[1000] transition-transform duration-500 ease-in-out ${popupClass} bg-black/40 backdrop-blur-sm`} onClick={closePopup}>
          <div className="w-[80vw] max-w-[1200px] max-h-[85vh] flex flex-row justify-start items-start bg-[#f4e0b9] p-[3rem] z-20 relative border-[12px] border-[#e7bb67] overflow-y-auto pr-3 bg-[#f4e0b9] rounded-xl shadow-xl rounded-[1rem]" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="w-[30%] flex-shrink-0 flex justify-center items-start pt-[2rem]">
              <div className="w-[12rem] h-[16rem] bg-[url('https://res.cloudinary.com/dybzo3xly/image/upload/v1742914160/bgSvg_mzeadi.svg')] bg-cover z-25 rounded-[1rem] flex flex-col justify-end items-center">
                <img src='https://instagram.fgau4-1.fna.fbcdn.net/v/t39.30808-6/469104934_18465127516011645_8070797185138041947_n.jpg?stp=dst-jpg_e35_tt6&_nc_cat=101&ig_cache_key=MzMyMTQ1ODMyMDU2MDA2MDU1NQ%3D%3D.3-ccb7-5&ccb=7-5&_nc_sid=58cdad&efg=eyJ2ZW5jb2RlX3RhZyI6InhwaWRzLjE0NDB4MTgwMC5zZHIuQzMifQ%3D%3D&_nc_ohc=cWneImrhUs4Q7kNvwFl5jEK&_nc_oc=AdrMippDSr9gscqRtSkY2qR0EMXhhXGzjoOzLTRc1N7GPCpp0uG2sTCkZS86W0_YHVE&_nc_ad=z-m&_nc_cid=0&_nc_zt=23&_nc_ht=instagram.fgau4-1.fna&_nc_gid=Y3tJVlSRkNCjTsH7ei_oOQ&_nc_ss=7a32e&oh=00_Af1WOZ6zhv9V22Exc7xF2rrP7FVcDFhuRkzPy7SFVFnGHg&oe=69D30415' className="inline-block w-[10rem] h-[13rem] object-cover object-center pt-[0.5rem] rounded-[1rem]" alt='Bishrut Saikia' />
            ...
            <div className="flex-1 pl-[2rem] flex flex-col justify-start items-center relative">
              <p className="font-moglan text-[3rem] font-[800] text-center p-[1rem] text-[#5f1516] whitespace-nowrap">Bishrut Saikia</p>
              
              <p className="text-[15px] font-gotham text-justify text-[#5f1516] font-[300] indent-[1rem]">
                {`শীতল দুই ওঁঠৰ স্মৃতি সোঁৱৰাই, পৰশৰ পিয়াসী হুমুনিয়াই কৈ যায়,পূৰ্ণতাৰে আৱৰাৰ দৰে তুমিও যে মোক কিমান ভাল পোৱা। দুচকুতে দুচকু থলে, লাজে চকু ঢাকি যায়।কেতিয়াবা তোমাক কন্দুৱাও যদি ক্ষমা কৰি দিবা তুমি, তুমি যেন উপহাৰ এটি। উপহাৰৰ দৰে সংগীতৰ সৃষ্টিৰে সাম্প্ৰতিক সময়ত নৱ প্ৰজন্মৰ হৃদয়ত এক সুৰৰ আলোড়নেৰে প্ৰেম ভালপোৱাৰ সুবাস বিয়পাই এক বিশেষ স্থান দখল কৰা প্ৰতিভাশালী কণ্ঠশিল্পী বিশ্ৰুত শইকীয়া, এইবাৰ ‘পছোৱা’ৰ মঞ্চলৈ আহি আছে এক শক্তিশালী আৰু বৈচিত্র্যময় সুৰৰে কিছু ক্ষণ জীপাল কৰি তুলিবলৈ। এক অনন্য অভিজ্ঞতাৰ সাক্ষী হৈ ৰ'বলৈ আপুনি বাৰু সাজু নে? যদি নহয়, তেন্তে সাজু হওঁক ৰাইজ.. উপভোগ কৰক এক অবিস্মৰণীয় অপূৰ্ব সন্ধ্যা। প্ৰতিটো সুৰ যেন এক কাহিনী, প্ৰতিটো গীত যেন এক যাত্ৰা- য’ত নিজক হেৰুৱাৰ মাজতেই লুকাই থাকে নিজক পুনৰাই বিচাৰি পোৱাৰ এক মিঠা অনুভৱ। এইবাৰ ‘পছোৱা’ৰ মঞ্চত তেওঁৰ সুৰৰ যাদুৰে  কপাঁই তুলিব প্ৰতিগৰাকী প্ৰেমিকৰ হৃদয়, ক্লান্ত‌ সময়ৰ অবসান ঘটাব তেওঁৰ উপহাৰে। এইয়া কেৱল এক অনুষ্ঠান নহয়, এইয়া এক সুৰৰ উৎসৱ — য’ত হৃদয়ত ধ্বনিত প্ৰতিটো সুৰেৰে লিখা হ’ব স্মৃতিৰ এখিলা পাত। আহক, একেলগে উপভোগ কৰোঁ এই মধুৰ ক্ষণ।`}</p>
              <p className="mt-[1rem] text-[16px] font-gotham text-justify text-[#5f1516] font-[600] indent-[1rem]">
               {` The memory of those gentle lips lingers on, whispering a quiet longing for your touch  softly reminding me how deeply you love me, like a warmth that wraps around completeness itself. When our eyes meet, shyness takes over, and the gaze turns away. If ever I make you cry, forgive me  for you are nothing less than a precious gift in my life.
                ...
                With melodies as heartfelt as a gift, the immensely talented singer Bishrut Saikia who has captured the hearts of the younger generation with his soulful voice and romantic aura is all set to grace the stage of Posua this time. Get ready to be enchanted by a powerful and versatile musical experience that will leave your spirit uplifted.
                
                Are you ready to witness something truly special? If not, now is the time to prepare.
                
                Come and immerse yourself in an unforgettable evening where every note tells a story, every song feels like a journey one where, in losing yourself, you discover a part of your soul all over again.
                
                This time, on the stage of Posua, his magical melodies will stir every lovers heart and soothe the weariness of time with his musical offerings. This is not just an event it is a celebration of music, where each echoing note will write a new page of memories.`}
              </p>
            </div>
