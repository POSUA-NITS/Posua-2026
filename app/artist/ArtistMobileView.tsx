          ...
          <div className={`fixed top-0 left-0 w-full h-[100dvh] flex justify-center items-center z-[1000] transition-transform duration-500 ease-in-out ${popupClass} bg-black/40 backdrop-blur-sm`} onClick={closePopup}>
            <div className="w-[85vw] max-h-[85vh] overflow-y-auto flex flex-col justify-start items-center bg-[#f4e0b9] p-[2rem] z-20 relative border-[8px] border-[#e7bb67] rounded-xl no-scrollbar" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="w-[12rem] h-[16rem] bg-[url('https://res.cloudinary.com/dybzo3xly/image/upload/v1742914160/bgSvg_mzeadi.svg')] bg-cover z-25 rounded-[1rem] flex flex-col justify-end items-center mt-2">
                <img src={selectedArtist === 'bishrut' ? 'https://instagram.fgau4-1.fna.fbcdn.net/v/t39.30808-6/469104934_18465127516011645_8070797185138041947_n.jpg?stp=dst-jpg_e35_tt6&_nc_cat=101&ig_cache_key=MzMyMTQ1ODMyMDU2MDA2MDU1NQ%3D%3D.3-ccb7-5&ccb=7-5&_nc_sid=58cdad&efg=eyJ2ZW5jb2RlX3RhZyI6InhwaWRzLjE0NDB4MTgwMC5zZHIuQzMifQ%3D%3D&_nc_ohc=cWneImrhUs4Q7kNvwFl5jEK&_nc_oc=AdrMippDSr9gscqRtSkY2qR0EMXhhXGzjoOzLTRc1N7GPCpp0uG2sTCkZS86W0_YHVE&_nc_ad=z-m&_nc_cid=0&_nc_zt=23&_nc_ht=instagram.fgau4-1.fna&_nc_gid=Y3tJVlSRkNCjTsH7ei_oOQ&_nc_ss=7a32e&oh=00_Af1WOZ6zhv9V22Exc7xF2rrP7FVcDFhuRkzPy7SFVFnGHg&oe=69D30415' : 'https://res.cloudinary.com/dybzo3xly/image/upload/v1743607390/ZubeenGarg_ybmmad.webp'} className="inline-block w-[10rem] h-[13rem] object-cover object-center pt-[0.5rem] rounded-[1rem]" alt={selectedArtist === 'bishrut' ? 'Bishrut Saikia' : 'Subasana Dutta'} />
              ...
              <div className="w-full flex flex-col justify-center items-center mt-6">
                ...
                <p className="text-[14px] font-gotham text-justify text-[#5f1516] font-[300] mt-4 max-w-full">
                 {selectedArtist === 'bishrut' 
                   ...
                   : `সুবাসনা দত্ত এগৰাকী অত্যন্ত জনপ্ৰিয় কণ্ঠশিল্পী। তেওঁৰ মধুৰ কণ্ঠ আৰু গায়ন শৈলীয়ে অসমৰ সংগীত জগতত এক সুকীয়া স্থান দখল কৰিছে। ডিফুৰ পৰা নিজৰ সংগীত যাত্ৰা আৰম্ভ কৰা সুবাসনাই হাজাৰ হাজাৰ শ্ৰোতাৰ হৃদয় জয় কৰিছে। তেওঁৰ শক্তিশালী মঞ্চ উপস্থিতি আৰু সুৰীয়া কণ্ঠই তেওঁক বৰ্তমানৰ সময়ৰ এগৰাকী অন্যতম শ্ৰেষ্ঠ শিল্পী হিচাপে প্ৰতিষ্ঠা কৰিছে। এইবাৰ ‘পছোৱা’ৰ মঞ্চত তেওঁ নিজৰ কালজয়ী গীতসমূহৰে সকলোকে আপ্লুত কৰিবলৈ সাজু হৈছে।`}
                </p>
                <p className="mt-[1rem] text-[14px] font-gotham text-justify text-[#5f1516] font-[600] max-w-full">
                  {selectedArtist === 'bishrut'
                    ...
                    : `Subasana Dutta is a prominent and widely celebrated playback singer from Assam. Known for her mesmerizing voice and versatile singing style, she has established herself as a household name in the Assamese music industry. Starting her journey from Diphu, she has touched countless hearts with her melodies. With a powerful stage presence and soulful resonance, she stands as one of the most beloved icons of our time. She is now set to enchant the audience at Posua with her timeless hits.`}
                </p>
              </div>
            </div>
          </div>
